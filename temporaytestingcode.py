...
##        mousePressed=pyqtProperty(QMouseEvent)
        ...
        self.MainText1.setFixedWidth(113)
        self.MainText1.move(190,170)
        self.MainText2.setFixedWidth(113)
        self.MainText2.move(190,250)
        self.MainText1.clicked.connect(self.numpadwindow1)
        self.MainText2.clicked.connect(self.numpadwindow2)
        self.StartButton.clicked.connect(self.start_spotdetect)
...
class AlertAll(QDialog):
    def __init__(self):
        super(AlertAll,self).__init__()
        loadUi('AlertAllBox.ui',self)
...
###            self.commandLabel.QLabel.setText(self.Gesturetext)
###            self.commandLabel.QLabel.setText(self.Balltext)
##
###            if self.Gesturetext==1:
###                self.commandLabel.QLabel.setText("hand")
###            if self.Balltext==2:
##             
###                self.commandLabel.QLabel.setText("ball")
##
##
##        
####        self.maskLabel.setPixmap(QPixmap.fromImage(outImage))
##        
